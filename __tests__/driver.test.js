const driver = require('../lib/app/driver/driver.js');
const emitter = require('../OLD/events.js');
...
describe('Testing the Driver: ', () => {
  ...
  it('Should emit delivered event at right time', () => {
    ...
    emitter.on('order-delivered', deliveredHandler);
